...
GitHub Repository: [https://github.com/your-username/Zork](https://github.com/hellosound/Zork/tree/1.0)
Release:: https://github.com/hellosound/Zork/releases/tag/1.0
License: MIT License
How to Play
Run the executable (Zork.exe).

The game starts with a short dialogue.

Enter your name and choose whether to begin the test.
...
WEST
QUIT – exit the game.
At certain points, you may be asked:
